...
for (page in 1:n_pages){
  ...
  main_site <- paste("https://www.amazon.in/s/ref=lp_4364643031_pg_", dig[page],"?rh=n%3A976392031%2Cn%3A%211499764031%2Cn%3A%211499765031%2Cn%3A4364643031&page=", dig[page], "&ie=UTF8&qid=1507980469",sep="")
...
colnames(df) <- c("Brand",
                  ...
                  "Customer review",
                  "Price")
write.csv(file = 'C:\\Users\\Vivek\\Desktop\\hp_lap.csv',df)